...
Page({
  ...
  refreshNewData: function () {
    //加载提示框
    var that = this;
    util.requestDynamic("GET", { a: "list", c: "data", type: types[this.data.currentTopItem] }).then(res => {
      page = 1;
  ...
  loadMoreData: function () {
    var that = this;
    util.requestDynamic("GET", { a: "list", c: "data", type: types[this.data.currentTopItem], page: page + 1, maxtime: this.getMaxtime() }).then(res => {
      page += 1;
